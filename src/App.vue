        ...
        <v-row class="mt-0">
          <v-col class="pt-2">
            ...
            >
              <v-menu open-on-hover offset-y m>
                <template v-slot:activator="{ on, attrs }">
                  <v-btn v-on="on" v-bind="attrs">
                    <span class="text-h6">오픈숍</span>
                  </v-btn>
                </template>
                <v-container class="white" fluid>
                  <v-row>
                    <v-col>
                      <span class="text-h6">최근등록상품</span>
                    </v-col>
                  </v-row>
                  <v-row>
                    <v-col cols="auto">
              ...
              <v-btn href="/blog">
                <span class="text-h6">상품평</span>
              </v-btn>
              <v-btn href="/blog">
                <span class="text-h6">이벤트</span>
              </v-btn>
              <v-menu open-on-hover offset-y>
                <template v-slot:activator="{ on }">
                  <v-btn v-on="on">
                    <span class="text-h6">고객센터</span>
                  </v-btn>
                </template>
                <v-card class="mx-auto" max-width="344" outlined>
                  <v-list-item
